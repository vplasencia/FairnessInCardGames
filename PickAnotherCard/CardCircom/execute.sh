...
cp input.json card_js/input.json

# Go inside the multiplier_js directory and generate the witness.wtns
cd card_js
node generate_witness.js card.wasm input.json witness.wtns
...
snarkjs zkey export solidityverifier card_0001.zkey verifier.sol
