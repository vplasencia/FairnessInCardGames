const main = async () => {
  ...
  let resultVerifyCard = await contract.verifyCard(
    [
  ...
  console.log("Result", resultVerifyCard);

  let resultVerifyAnotherCard = await contract.verifyAnotherCard(
    [
  ...
  console.log("Result", resultVerifyAnotherCard);
};
